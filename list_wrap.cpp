...
#define SWIGTYPE_p_ListT_float_t swig_types[0]
...
/*-----------------------------------------------
              @(target):= _list_swig.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__list_swig

#else
#  define SWIG_init    init_list_swig

#endif
#define SWIG_name    "_list_swig"
...
SWIGINTERN PyObject *_wrap_new_FloatList(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ListT_float_t, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
static swig_type_info _swigt__p_ListT_float_t = {"_p_ListT_float_t", "List< float > *|FloatList *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ListT_int_t = {"_p_ListT_int_t", "IntList *|List< int > *", 0, 0, (void*)0, 0};
